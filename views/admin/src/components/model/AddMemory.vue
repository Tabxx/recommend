<template>
  <el-dialog title="添加内存条" :visible.sync="dialogFormVisible">
    <el-form :model="form" label-width="120px">
      ...
      <template v-if="addActive==1">
        ...
        <el-form-item label="品牌">
          <el-col :span="10">
            <el-input v-model="form.brand" autocomplete="off" placeholder="影驰" clearable></el-input>
          </el-col>
        </el-form-item>
      ...
      { type: 'number', message: '价格必须为数字值'}
        ...
        <el-form-item label="内存容量">
          <el-col :span="10">
            <el-input v-model="form.capacity" autocomplete="off" placeholder="11(GB)" clearable></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="显卡类型">
          <el-col :span="10">
            <el-input v-model="form.type" autocomplete="off" placeholder="GDDR6" clearable></el-input>
          </el-col>
        </el-form-item>
      ...
      <template v-if="addActive==2">
        <el-form-item label="针脚数">
          <el-col :span="10">
            <el-input v-model="form.stitch_count" autocomplete="off" placeholder="288pin" clearable></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="插槽类型">
          <el-col :span="10">
            <el-input v-model="form.slot_type" autocomplete="off" clearable></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="插槽延迟">
          <el-col :span="10">
            <el-input v-model="form.cl_delay" autocomplete="off" placeholder="三风扇散热" clearable></el-input>
          </el-col>
        </el-form-item>
        <el-form-item label="内存主频">
          <el-col :span="10">
            <el-input v-model="form.frequency" autocomplete="off" placeholder="2400(MHz)" clearable></el-input>
          </el-col>
        </el-form-item>
      </template>
      <!-- ./基础参数 -->
      ...
      <template v-if="addActive==3">
        ...
        <el-form-item label="工作电压">
          <el-col :span="10">
            <el-input v-model="form.work_voltage" autocomplete="off" placeholder="12(V)" clearable></el-input>
          </el-col>
        </el-form-item>
